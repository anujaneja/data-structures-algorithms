...
public class RepeatAndMissingArray {
    ...
    private static class Solution {
        ...
        /**
         * Logic used is to use hashSet to find repeated number and
         * missing number is find by the following eq:
         * sumActual  = sum(1..N)+repeatedNum - missingNumber;
         * @param A
         * @return
         */
        public ArrayList<Integer> repeatedNumber1(final List<Integer> A) {
            int repeatedElement = 0;
            double missingElement = 0;
            double sumArr = (A.size()*(A.size()+1))/2;
            double actualSum=0;
